...
RSpec.describe User, type: :model do
  describe 'Validations' do
    ...
    it "returns 'First name can't be blank' if we try to create a User with a nil value in the first name field"  do 
      @user = User.new({password:'nintendo', password_confirmation: 'nintendo', email: 'nintendo@gmail.com', first_name: nil, last_name: "Brothers" })
    ...
    it "should display Last name can't be blank!" do 
      @user = User.new({password:'nintendo', password_confirmation: 'nintendo', email: 'nintendo@gmail.com', first_name: "Mario", last_name: nil })
    ...
    it "should display email can't be blank!" do 
      @user = User.new({password:'nintendo', password_confirmation: 'nintendo', email: nil, first_name: "Mario", last_name: "Brothers" })
    ...
    it "should display password can't be blank!" do 
      @user = User.new({password:nil, password_confirmation: 'nintendo', email: 'nintendo@gmail.com', first_name: "Mario", last_name: "Brothers" })
    ...
    it "should display password can't be less than 5 characters!" do 
      @user = User.new({password: "hi", password_confirmation: "hi", email: 'nintendo@gmail.com', first_name: "Mario", last_name: "Brothers" })
    ...
    it "should display password does not match the password confirmation" do 
      @user = User.new({password: "nintendo", password_confirmation: "hi", email: 'nintendo@gmail.com', first_name: "Mario", last_name: "Brothers" })
  ...
  describe '.authenticate_with_credentials' do
    ...
    it "returns an instance of the user model if an existing user tries to login with the correct email and password" do
      ...
      expect(User.authenticate_with_credentials('nintendo@gmail.com', 'nintendo' )).to eq(@user)
    end
    ...
    it "returns nil if an existing user tries to login with the correct email and incorrect password" do
      ...
      expect(User.authenticate_with_credentials('nintendo@gmail.com', 'hi' )).to be nil
    end
    ...
    it "returns nil if user attempts to login with an email that is not in the database " do
      ...
      expect(User.authenticate_with_credentials('atari@gmail.com', 'nintendo' )).to be nil
    end
